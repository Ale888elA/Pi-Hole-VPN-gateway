...
While is quite simple to disable IPv6 traffic through the configuration of the network manager on your PC or laptop, and also many Smart-TV gives the oprion in network settings, is way more difficult on your smartphone because it will probably require root pribileges; setting the RPI as your gateway while your smartphone is connected to the LAN will block all IPv6 traffic.   
